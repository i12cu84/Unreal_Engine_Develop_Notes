import pandas as pd
a1= pd.read_excel(r"C:\Users\LENOVO\Desktop\国赛\C\附件2：302家无信贷记录企业的相关数据.xlsx",sheet_name='进项发票信息')
a11=pd.read_excel(r"C:\Users\LENOVO\Desktop\国赛\C\附件2：302家无信贷记录企业的相关数据.xlsx",sheet_name='销项发票信息')
a3= pd.read_excel(r"C:\Users\LENOVO\Desktop\国赛\C\附件2：302家无信贷记录企业的相关数据.xlsx",sheet_name='企业信息')
x=[]
for i in range(302):
    x.append('E'+str(i+124))
num=0
a3['进项金额增加']=0
a3['进项金额减少']=0
a3['销项金额增加']=0
...
# a3.to_csv(r'C:\Users\LENOVO\Desktop\国赛\C\附录C的数据.csv', encoding='utf_8_sig')
a3['蓝票率']=1-a3['蓝票率']
a3[['企业代号','回扣率','蓝票率','资产转化率','净利润占比']].to_csv(r'C:\Users\LENOVO\Desktop\国赛\C\附录C的数据.csv', encoding='utf_8_sig')