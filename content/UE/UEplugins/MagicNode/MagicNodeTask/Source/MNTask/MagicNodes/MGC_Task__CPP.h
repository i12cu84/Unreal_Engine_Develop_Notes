...
#include "MGC_Task__CPP.generated.h"
...
UCLASS()
class MNTASK_API UMGC_Task__CPP : public UMagicNode
{
	GENERATED_BODY()

public:

UFUNCTION (BlueprintCallable,Category="Magic Node",meta=(WorldContext="Context",BlueprintInternalUseOnly="true",ToolTip="UMGC_Task__CPP"))
 static void Execute(
	UObject* Context,
	AActor* Actor,
