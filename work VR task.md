...
开关
    ...
    安装:
        ...
        塞尺测量(塞得进去,塞不进去) 塞尺内移两个动画
        传动杆旋转时 ABC三组隔离开关 会进行联动
        安装隔离开关板 螺丝从下往上 垫片从上往下 螺母旋转下降
        传动杆 两个螺丝从上往下 旋转下降 传动杆从里到外
        [测]传动杆头尾水平
        [?]水平后安装总传动连杆
    ...
    检调[?]:
        ...
        若开口过大,则需要调节底部限位
        使用水平尺矫正后,微调限位螺丝
        若开关铜板出现锈蚀等现象需要使用磨砂纸去锈

变压器巡检动作

    巡检:
        油管颜色(蓝色正常,红色缺油)有无破损,有无油污/漏油,有无放电
        绝缘子是否松动 破损 漏油 (高低压7个都要看)
        绝缘子 顶部是否有散落放电痕迹,套管是否有变色
        低压端0接地,观察接地情况,是否有破损
